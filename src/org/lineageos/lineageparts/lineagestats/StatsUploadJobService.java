...
public class StatsUploadJobService extends JobService {
    ...
    private static final String TAG = "lluviaStats";
    private static final boolean DEBUG = true;

    public static final String KEY_JOB_TYPE = "job_type";
    public static final int JOB_TYPE_LLUVIA = 1;
    ...
    private boolean uploadToLluvia(JSONObject json) throws IOException {
        final Uri uri = Uri.parse(getString(R.string.stats_lluvia_url));
        ...
        try {
            ...
            if (DEBUG) Log.d(TAG, "lluvia server response code=" + responseCode);
